...
public class CustomerController {
	...
	public ResponseEntity<String> deleteCustomert(@PathVariable("custId") Long custId) {
		if (customerService.isCustomerExists(custId)) {
	...
	@GetMapping("/getCustomer/CustomerName/{custName}")
	public ResponseEntity<Customer> getCustomerByName(@PathVariable String custName) {
